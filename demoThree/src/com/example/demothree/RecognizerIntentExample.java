//2. We use the intent to call the recognizer which is a library of functions that comes with Android. We use this functionality to get results from the users voice.
...
intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, 
                        RecognizerIntent.LANGUAGE_MODEL_FREE_FORM); intent.putExtra(RecognizerIntent.EXTRA_PROMPT, 
